...
public class SocialAuthController {
	...
	public String redirectToGoogleLogin() {
		String redirectUri = "https://accounts.google.com/o/oauth2/v2/auth" + "?client_id="
				+ properties.getGoogleClientId() + "&redirect_uri=" + properties.getGoogleRedirectUri()
				+ "&response_type=code" + "&scope=" + properties.getGoogleScope() + "&access_type=offline";
	...
	public String redirectToNaverLogin() {
		String redirectUri = "https://nid.naver.com/oauth2.0/authorize" + "?client_id=" + properties.getNaverClientId()
				+ "&redirect_uri=" + properties.getNaverRedirectUri() + "&response_type=code" + "&state=naverLogin";
		return "redirect:" + redirectUri;
	}
	...
	public String redirectToKakaoLogin() {
		String redirectUri = "https://kauth.kakao.com/oauth/authorize" + "?client_id=" + properties.getKakaoClientId()
				+ "&redirect_uri=" + properties.getKakaoRedirectUri() + "&response_type=code" + "&scope="
				+ properties.getKakaoScope();
		return "redirect:" + redirectUri;
	}
